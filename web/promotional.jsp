        ...
        <div class="super_container">
            ...
            <div class="container" style=" min-height: 600px; margin-top: 150px">
                ...
                <div class="row center-content">
                    <div class="container">
                        <div class="row combo-list d-flex align-content-center" id="1">
                            <div
                            ...
                            <div class="col-md-7 ml-4 m-2">
                                <div class="row title-combo p-3">
                                    <h3 data-toggle="modal">Combo Tien Loi</h3>
                                </div>
                                ...
                                <div class="row add-cart p-3 mt-3 justify-content-center">
                                    <button class="btn w-100">
                                        <a href="hello.html">Add to cart</a>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-lg mt-5" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="myModalLabel">Combo Tien loi</h3>
                                <button
                                    type="button"
                                    class="close m-2"
                                    data-dismiss="modal"
                                ...
                                <div
                                    ...
                                    <div class="col-md-6 left-infor">
                                        ...
                                        <div class="row d-flex justify-content-center align-items-center ml-4 mr-4 ">
                                            <button class="btn w-100"><a href="hello.html">Add to cart</a></button>
                                        </div>
